...
// from: import type { Evaluate } from "@wagmi/core/internal";
...
frameConnector.type = "frame" as const;
export function frameConnector(parameters: FrameParameters = {}) {
  function getTarget(): Evaluate<Target & { id: string }> {
    const target = parameters.target ?? (ethProvider as any)("frame");
